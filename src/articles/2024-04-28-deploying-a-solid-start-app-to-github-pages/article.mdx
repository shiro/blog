...
│                        │
├────────────────────────╯
[shiro@local:~]# cd my-blog
[shiro@local:~/my-blog]# pnpm install
Done in 23.3s
```
...
```ansi terminal
[shiro@local:~/my-blog]# git init
Initialized empty Git repository in ~/my-blog/.git/
[shiro@local:~/my-blog]# git remote add origin git@github.com:username/my-blog.git
[shiro@local:~/my-blog]# git add .
[shiro@local:~/my-blog]# git commit -m "Initial commit"
[shiro@local:~/my-blog]# git push
